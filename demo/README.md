...
| Brique #8 — le curateur naturel | [`brique-8-curateur-naturel.md`](brique-8-curateur-naturel.md) | qualité conversationnelle par défaut : forme de tour prescrite (verrou / ancrage chiffré / enjeu / options / « je ne sais pas »), une seule question par tour, brouillon de fiche émis à chaque tour (invisible pour l'humain) | à venir (`v0.12.0`) |
