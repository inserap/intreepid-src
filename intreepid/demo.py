"""Démo montrable : profile_stats brut → verdict de l'agent.
...
QUESTION = ("Profile accidents_route : accidents plus graves en fin d'année ? "
...
def main():
    ...
    print(json.dumps(profile_stats(con, "accidents_route", fiche), ensure_ascii=False, indent=2, default=str))
    print("\n=== verdict de l'agent ===")
